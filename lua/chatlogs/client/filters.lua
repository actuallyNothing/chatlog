function Chatlog.DrawMoreFilters(parent, y, height)
    ...
    local hideDeadPlayers = vgui.Create("DCheckBoxLabel", panel)
        hideDeadPlayers:SetText(Chatlog.Translate("FiltersHideDead"))
        hideDeadPlayers:SetTextColor(Chatlog.Filters.dead and Color(255, 255, 0) or Color(0, 0, 0))
        hideDeadPlayers:SetPos(10, 130)
        hideDeadPlayers:SizeToContents()
    ...
    hideDeadPlayers.OnChange = function(self, val)
        Chatlog.Filters.hideDead = val
        hideDeadPlayers:SetTextColor(val and Color(255, 255, 0) or Color(0, 0, 0))
    end

    filterTeam:SetValue(Chatlog.Filters.team)
    filterRoles:SetValue(Chatlog.Filters.roles.enabled)
    hideDeadPlayers:SetValue(Chatlog.Filters.hideDead)
